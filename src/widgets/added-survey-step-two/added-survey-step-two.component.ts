      ...
      @for (item of questionsOrAnswersItems();track item) {
        <div class="flex gap-1 flex-col" >
          <div class="flex w-full items-start gap-6">
            ...
            <app-text-area (value)="checkStatus($event, item.sequence)" class="w-[760px]" valueLabel="Введите вопрос" >
          ...
          @if(item.showAnswers) {
            <app-added-survey-questions-block [answers]="item.options" class="max-w-[620px] ml-12">
