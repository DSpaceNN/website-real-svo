        ...
        <div>
          <form action="">
            <div class="mb-5">
              ...
              <input type="email" name="email" id="email" placeholder="you@company.com" class="text-white w-full px-4 py-2.5 placeholder-gray-custom-opacity-800 border-2 border-white-400 bg-transparent  focus:outline-none  " />
            </div>
            <div class="mb-5">
              <div class="flex justify-between mb-1">
                <label  for="password" class="text-sm text-gray-600 text-gray-custom-opacity-700">Пароль</label>
              </div>
              <input type="password" name="password" id="password" placeholder="Пароль" class="text-white w-full px-4 py-2.5 placeholder-placeholder-gray-custom-opacity-800 border-2  focus:outline-none bg-transparent  " />
            </div>
            <div class="md:mb-5">
              <app-line-light-gray></app-line-light-gray>
            </div>
