...
@Component({
  ...
  <div class="relative">
    <div class="flex gap-1">
      ...
      <textarea maxlength="500" [value]="inputValue()" (ngModelChange)="value.emit($event)" [(ngModel)]="valueTextArea" #area id="area" rows="4" class="resize-none block p-2.5 w-full border-light-gray-admin border-[2px] rounded-[8px] max-h-[80px] no-scrollbar" placeholder="Write your thoughts here..."></textarea>
